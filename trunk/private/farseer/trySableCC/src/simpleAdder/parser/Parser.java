...
public class Parser
{
    ...
    @SuppressWarnings("unchecked")
    ArrayList new0() /* reduce ASingleProgram */
    {
    ...
    @SuppressWarnings("unchecked")
    ArrayList new1() /* reduce ASequenceProgram */
    {
        @SuppressWarnings("hiding") ArrayList nodeList = new ArrayList();
        ...
        pprogramNode1 = new ASequenceProgram(pprogramNode2, pstatementNode3);
        }
	nodeList.add(pprogramNode1);
        return nodeList;
    }
    ...
    @SuppressWarnings("unchecked")
    ArrayList new2() /* reduce AStatement */
    {
        @SuppressWarnings("hiding") ArrayList nodeList = new ArrayList();
        ...
        pstatementNode1 = new AStatement(tintegerNode2, tplusNode3, tintegerNode4, tsemiNode5);
        }
...
/*      {
			{{-1, ERROR, 0}, {0, SHIFT, 1}, },
			{{-1, ERROR, 1}, {1, SHIFT, 4}, },
			{{-1, ERROR, 2}, {0, SHIFT, 1}, {3, ACCEPT, -1}, },
			{{-1, REDUCE, 0}, },
			{{-1, ERROR, 4}, {0, SHIFT, 6}, },
			{{-1, REDUCE, 1}, },
			{{-1, ERROR, 6}, {2, SHIFT, 7}, },
