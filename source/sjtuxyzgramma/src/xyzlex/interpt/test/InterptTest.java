...
public class InterptTest extends TestCase {
	...
	public void testBoolean001() throws ParserException, LexerException, IOException{
		Interpt interpt=new Interpt("boolean a;int b;a=true;if(a){b=0;}else{b=1;}" +
	...
	public void testBoolean002() throws ParserException, LexerException, IOException{
		Interpt interpt=new Interpt("boolean a;int b;a=false;if(a){b=0;}else{b=1;}" +
				"System.out.println(b);");
		List<String> output=interpt.getOutputs();
		assertEquals(output.size(), 1);
		assertEquals(output.get(0), "1");
	...
	public void testNew002() throws ParserException, LexerException, IOException{
		Interpt interpt=new Interpt("real [] a;a=new real[10];a[0]=1.1;System.out.println(a[0]);");
		List<String> output=interpt.getOutputs();
		assertEquals(output.size(), 1);
